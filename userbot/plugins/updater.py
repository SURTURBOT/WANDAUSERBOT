...
BOT_IS_UP_TO_DATE = "**The THANOSBOT-PRO** is up-to-date sir."
NEW_BOT_UP_DATE_FOUND = (
    "new update found for {branch_name}\n"
    "changelog: \n\n{changelog}\n"
    "updating your THANOSBOT-PRO ..."
)
NEW_UP_DATE_FOUND = "New update found for {branch_name}\n" "`updating your THAONSBOT-PRO...`"
...
async def updater(message):
    ...
    if not changelog:
        await message.edit("`⚡⚡𝚁𝚞𝚔𝚘 𝙹𝚊𝚛𝚊 𝚜𝚊𝚋𝚛𝚊 𝚔𝚊𝚛𝚘 𝚞𝚙𝚍𝚊𝚝𝚎 𝙷𝚘 𝚗𝚎 𝚓𝚊 𝚛𝚑𝚊 𝚑 THAONSBOT_V-Pro⚡⚡`")
